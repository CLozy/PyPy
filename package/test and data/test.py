...
class TestGaussianClass(unittest.TestCase):
    def setUp(self):
        ...
        self.gaussian.read_data_file(
            r'C:\Users\Hp\Desktop\MachineLearning-Engineer\PROJECTS\Udacity\ud120-projects\env\Lib\site-packages\PyPy\package\numbers.txt')
